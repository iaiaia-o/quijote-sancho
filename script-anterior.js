...
async function showFinalResult() {
    ...
    // --- SIMULACIÓN DE LLAMADAS A IA ---
    // En una aplicación real, aquí se harían las llamadas al backend o API de Gemini.
    // Usamos setTimeout para simular la asincronía y el tiempo de espera.
    ...
    // Simulación de respuesta de IA para el análisis de texto
    ...
    // Simulación de respuesta de IA para la descripción del escudo
    ...
    // Simulación de respuesta de IA para la imagen del escudo
    const img = document.createElement('img');
    img.src = "https://storage.googleapis.com/gweb-aip-static/gemini/mendel/15.png";
    img.alt = "Escudo Heráldico generado por IA";
